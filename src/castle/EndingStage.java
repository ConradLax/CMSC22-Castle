...
//	private TheGame game;
	public final Image bg = new Image("images/plainroom.jpg",1366,768,false,false);
...
//		this.gc.drawImage(bg,0,0);
		...
		this.gametimer = new GameTimer(this.gc,this.scene, this.stage,4,this.mainScene);
...
//		firstStage.play();
		...
		EndingStage.group.getChildren().addAll(bg1,this.canvas, this.newCanvas);
